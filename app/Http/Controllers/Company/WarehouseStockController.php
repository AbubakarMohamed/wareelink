...
class WarehouseStockController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Company/WarehouseStocks/Index', [
            'stocks'     => $stocks,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('company.warehouse-stocks.index')
    ...
    public function storeMultiple(Request $request)
    {
        ...
        return redirect()->route('company.warehousestocks.index')
